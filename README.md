...
A Python Flask chatbot web app that integrates Gemini (for natural conversation and music recommendations) and Spotify (for searching tracks and creating playlists).
